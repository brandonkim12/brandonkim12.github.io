...
Position vector $\mathbb{r}$ is often related to the cartesian coordinates. In this time,

$$\hat{\mathbb{q_1}}\,=\, \frac{\frac{\partial{\mathbb{r}}}{\partial{q_1}}}{\left|\frac{\partial{\mathbb{r}}}{\partial{q_1}}\right|},\, \hat{\mathbb{q_2}}\,=\, \frac{\frac{\partial{\mathbb{r}}}{\partial{q_2}}}{\left|\frac{\partial{\mathbb{r}}}{\partial{q_2}}\right|},\,\hat{\mathbb{q_3}}\,=\, \frac{\frac{\partial{\mathbb{r}}}{\partial{q_3}}}{\left|\frac{\partial{\mathbb{r}}}{\partial{q_3}}\right|}$$. Now, for the convenience of calculation, we take $$h_1\,=\,\left|\frac{\partial{\mathbb{r}}}{\partial{q_1}}\right|,\,h_2\,=\,\left|\frac{\partial{\mathbb{r}}}{\partial{q_2}}\right|,\,h_3\,=\,\left|\frac{\partial{\mathbb{r}}}{\partial{q_3}}\right|$$, so we get $$\frac{\partial{\mathbb{r}}}{\partial{q_i}}\,=\,h_i\hat{\mathbb{q_i}}$$



<center>2) Whole differential terms of x,y,z</center>

$d\,x=\,\frac{\partial x}{\partial {q_1}}dq_1\,+\,\frac{\partial x}{\partial {q_2}}dq_2\,+\,\frac{\partial x}{\partial {q_3}}dq_3$, $d\,y=\,\frac{\partial y}{\partial {q_1}}dq_1\,+\,\frac{\partial y}{\partial {q_2}}dq_2\,+\,\frac{\partial y}{\partial {q_3}}dq_3$, $d\,z=\,\frac{\partial z}{\partial {q_1}}dq_1\,+\,\frac{\partial z}{\partial {q_2}}dq_2\,+\,\frac{\partial z}{\partial {q_3}}dq_3$.
