...
Position vector $\mathbb{r}$ is often related to the cartesian coordinates. In this time, <img src="assets/1.png" alt="hi" class="inline"/>  Now, for the convenience of calculation, we take  <img src="assets/1.png" alt="hi" class="inline"/>so we get <img src="assets/3.png" alt="hi" class="inline"/>
