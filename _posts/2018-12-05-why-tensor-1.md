...
Position vector $\mathbb{r}$ is often related to the cartesian coordinates. In this time, ![useful image](https://github.com/brandonkim12/brandonkim12.github.io/blob/master/assets/1.PNG)Now, for the convenience of calculation, we take  ![useful image](https://github.com/brandonkim12/brandonkim12.github.io/blob/master/assets/2.PNG)so we get ![useful image](https://github.com/brandonkim12/brandonkim12.github.io/blob/master/assets/3.PNG)
