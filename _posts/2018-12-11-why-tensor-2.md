...
Differentiating $\tag{3.1}$ in accordance with $\theta$ to make $\sigma_{x'}$ maximized,
...
If $\frac{\sigma_x\,+\,\sigma_y}{2}$is to be $\sigma_{avg}\,=\,\frac{\sigma_x\,+\,\sigma_y}{2}$, $\tag{3.1}$ can be said to

$$\sigma_{x'}\,=\,\sigma_{avg}\,+\,\frac{\sigma_x\,-\sigma_y}{2}cos2\theta\,+\tau_{xy}sin2\theta\tag{3.4}$$

make above $\theta$ to $\theta_{x'}$, because it is about the stress along with  $x'$ axis. Comparing $\tag{3.3}$ with $\tag{3.1}$, when the angle $\theta$ goes to $\theta_{x'}$, we can find that$\tau_{x'y'} = 0$. In other words, <u>when the stress along the $x'$ axis is to be maximized, the stress along the $x'y'$ axis would be $0$.</u>

For the $\theta_{x'}$, put $\tag{3.3}$ to $\tag{3.1}$, and the result is like below:
...
For the $\theta_{x'y'}$, put $\tag{3.6}$ to $\tag{3.2}$, and the result is like below:
...
adding the square of $\tag{3.2}$ and $\tag{3.4}$,
...
$$\begin{align}\sigma_{x'}\,&=\sigma_x\,cos^2\theta\,+\,\sigma_y\,sin^2\theta\,+\tau_{xy}sin2\theta\\ & = \frac{\sigma_x+\sigma_y}{2}\,+\,\frac{\sigma_x\,-\sigma_y}{2}cos2\theta\,+\tau_{xy}sin2\theta\,\end{align}\tag{3.9} $$

$\tau_{x'y'}\,=\,-\frac{1}{2}(\sigma_x-\sigma_y)sin2\theta+\tau_{xy}cos2\theta\tag{3.10}$
